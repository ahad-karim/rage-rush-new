...
int logo, newgamebut, continuebut, volon, voloff, scores, levelbut, background1, menubg, sublevel1bg, sublevel2bg, sublevel3bg, sublevel4bg, win, gameover;
